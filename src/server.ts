...
import { checkConnection } from '../src/elasticsearch';
...
const chatErrorHandler = (app: Application): void => {
  app.use(
    (
      ...
      log.log('error', `Communication Service ${error.comingFrom}:`, error);
...
const startServer = async (app: Application): Promise<void> => {
  try {
    ...
    log.log(
      'error',
      'Communication Service startServer() method error:',
      error,
    );
  }
};
...
const startHttpServer = (httpServer: http.Server): void => {
  try {
    ...
    log.log(
      'error',
      'Communication Service startHttpServer() method error:',
      error,
    );
  }
};
